...
public class Publisher implements Serializable{
	private static final long serialVersionUID = 6504628676361972851L;
	...
	public String toString() {
		return "Publisher [publisherId=" + publisherId + ", publisherName=" + publisherName + ", publisherPhone="
				+ publisherPhone + ", publisherAddress=" + publisherAddress + "]";
	}
	/* (non-Javadoc)
